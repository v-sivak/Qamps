...
#    
    path = r'/Users/vs362/Google Drive (vladimir.sivak@yale.edu)/Qulab/JTLA/DATA/'   
    
    JTLA01 = JTLA(path,'JTLA01',200)
...
#    JTLA08 = JTLA(path,'JTLA08',1003) 
#    JTLA08_v2 = JTLA(path,'JTLA08_v2',1003) 
    JTLA08_v3 = JTLA(path,'JTLA08_v3',1003)     
